...
const PersonDetails = ({ person }) => {
  ...
  const OtherMedia = person.combined_credits.cast;

  return (
    <>
      <Head>
        <title>{person.name} | QuickFlicks</title>
        ...
        <div className='w-full overflow-hidden flex-col flex '>
          ...
          <div className='flex flex-col md:mt-5 mt-3'>
            ...
            <div className='mt-5 w-full h-80'>
              <h2 className='font-bold text-white text-lg'>Popular Medias</h2>
              <div className='flex overflow-x-auto gap-5 h-full pt-5'>
                {popular.map((media) => (
                  <div>
      ...
      <div className='mx-4 mt-10 flex flex-col w-full'>
        <h3 className='font-bold text-white underline decoration-red-800 underline-offset-4 text-3xl'>
          Media
        </h3>
        <Paginator
